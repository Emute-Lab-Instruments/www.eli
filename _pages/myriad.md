...
{% include spectro_video.html
   files     = "/assets/video/myriad/drone.mp4|Myriad Drone Demo"
   height    = "720"
   vizheight = "200"
   color     = "23a5d9"
%}
...
{% include spectro_video.html
   files     = "/assets/video/myriad/sequenced.mp4|Myriad Sequence Demo"
   height    = "720"
   vizheight = "200"
   color     = "23a5d9"
%}

The above video shows Myriad being sequenced.  Our [uSeq](/useq) module is creating patterns for gates and 1V/oct control, and the neighboring Dark Star module is generating an envelope which is being fed in to Myriad's VCA. The player varies combinations of oscillator models, along with spread, epsilon, interval and envelope release.
